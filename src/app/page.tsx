...
type ParticleOverrides = Partial<
  Pick<
    ParticleStyle,
    | "width"
    | "height"
...
export default function Home() {
  ...
  const particles = useMemo(() => {
    const random = createSeededRandom(0xdec0de);
    const rng = (min: number, max: number) => random() * (max - min) + min;
    const items: ParticleStyle[] = [];

    const pushParticle = (style: ParticleOverrides) => {
      items.push({
        ...style,
        left: `${rng(0, 100)}%`,
        top: `${rng(0, 100)}%`,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
          ...
          <div className="md:hidden border-t border-gray-200 bg-white">
            <div className="max-w-7xl mx-auto px-4 py-3 space-y-2">
              ...
              <button
                ...
                className="w-full mt-2 px-4 py-2 bg-gray-900 text-white rounded-lg"
              >
                Live Demo
              </button>
            </div>
            ...
            <div className="text-left md:pr-6 transition-all duration-700 ease-out motion-safe:translate-y-0 motion-safe:opacity-100 translate-y-2 opacity-95">
              <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight">
                ...
                <span className="text-xl sm:text-2xl md:text-3xl">
                  in an Augmentative Raspberry Pi–Based System for Urine
                  Microscopy Analysis
                </span>
              </h1>
          ...
          <div className="grid md:grid-cols-3 gap-10 text-left">
            <div className="transition-transform duration-300 hover:-translate-y-1 bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-base md:text-lg text-gray-700">
                Link your microscope and start a live feed in seconds.
              </p>
            </div>
            <div className="transition-transform duration-300 hover:-translate-y-1 bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2">
              ...
              <p className="text-base md:text-lg text-gray-700">
                The model identifies, counts, and classifies sediments
                accurately.
              </p>
            </div>
            <div className="transition-transform duration-300 hover:-translate-y-1 bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-base md:text-lg text-gray-700">
                Get a professional, comprehensive report ready for review.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-20">
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 text-center mb-12">
              A Smarter Workflow for Your Lab
            </h2>
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white p-8 rounded-xl shadow transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <p className="text-base md:text-lg text-gray-700">
                  Reduce manual errors with modern multimodal analysis.
                </p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-1">
                ...
                <p className="text-base md:text-lg text-gray-700">
                  Monitor samples with a real-time, high-quality stream.
                </p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-1">
                ...
                <p className="text-base md:text-lg text-gray-700">
                  Organize patient data and access historical results.
                </p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-1">
                ...
                <p className="text-base md:text-lg text-gray-700">
                  Generate clear, concise reports instantly.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-2 mb-12 bg-white p-6 md:p-8 rounded-2xl shadow">
            <p className="text-base md:text-lg text-gray-700 max-w-5xl mx-auto">
              An undergraduate thesis project for Bachelor of Science in
              Computer Engineering at
              <span className="font-semibold text-blue-700">
                {" "}
                Pamantasan ng Lungsod ng Maynila (PLM)
              </span>
              . This cost-effective, Raspberry Pi–based augmentative microscopy
              urinalysis system enhanced with Vision-Language Models aims to
              democratize access to reliable urinalysis diagnostic automation
          ...
          <div className="mt-6 mb-12 bg-white p-6 md:p-8 rounded-2xl shadow">
            ...
            <div className="max-w-5xl mx-auto space-y-4">
              <p className="text-base md:text-lg text-gray-700">
                These Vision-Language Models (VLMs) have demonstrated remarkable
                potential in analyzing complex visual data while providing
                human-interpretable explanations. In the context of medical
                diagnostics, this presents an unprecedented opportunity to
                explore whether these advanced AI systems can revolutionize
                automated urinalysis analysis.
              </p>
              <p className="text-base md:text-lg text-gray-700">
                MicroView AI is a cost-effective, Raspberry Pi–based urine
                microscopy system enhanced with Vision-Language Models (VLMs)
                that investigates the application of state-of-the-art AI to
                urine sediment microscopy, exploring their potential to provide
                accurate, explainable, and cost-effective analysis that could
                democratize access to reliable diagnostic automation for
                resource-constrained laboratories.
              </p>
              <p className="text-base md:text-lg text-gray-700">
                Unlike expensive commercial analyzers, this approach emphasizes
                both affordability and transparency, addressing the critical gap
                in diagnostic access by providing a practical, trustworthy tool
                that bridges the gap between manual and fully automated
                analysis.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 mb-20 bg-white p-8 rounded-2xl shadow">
            ...
            <p className="text-lg text-gray-700 mb-6 text-center max-w-4xl mx-auto">
              This research contributes to the advancement of accessible medical
              diagnostics and demonstrates the potential of Visual-Language
              Models in healthcare technologies. The findings provide a
              foundation for democratizing reliable urinalysis and addressing
              the persistent access-accuracy gap in diagnostic services,
              especially in third world countries where access to such advanced
              diagnostic machines is limited due to high costs and
              infrastructure requirements.
            </p>
            <p className="text-lg text-gray-700 text-center max-w-4xl mx-auto">
              By combining low-cost hardware with transparent AI, this work
              positions itself as a viable step toward ensuring diagnostic
              equity across diverse clinical settings.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-200/95 mb-8">
            See how MicroView AI can empower your team.
          </p>
          <button
            onClick={handleDemoClick}
